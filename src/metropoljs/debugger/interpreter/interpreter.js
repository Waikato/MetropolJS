...
// getCurrentNode and getAllNodes were added by Joshua Scarsbrook for ASTBSP.
...
Interpreter.prototype.step = function() {
    ...
    try {
        if (this.stepFunctions_[type] === undefined) {
 ...
 */
Interpreter.prototype.getCurrentNode = function(depth) {
    depth = depth || 1;
    var stack = this.stateStack;
    var state = stack[stack.length - depth];
    if (!state) {
        return null;
    }
    return state.node;
...
/**
 * Get all nodes on the stack.
 */
Interpreter.prototype.getAllNodes = function() {
    var stack = this.stateStack;
    return stack.map(function(state) {
        if (!state) {
            return null;
        } else {
            return state.node;
 ...
 */
Interpreter.prototype.setEventCallback = function(fn) {
    this.eventCallback = fn;
};

/**
 * Emit a event to an eventCallback
 */
Interpreter.prototype.emitEvent = function(name) {
    if (this.eventCallback) {
        this.eventCallback.apply(this, arguments);
    }
};

/**
 * Execute the interpreter to program completion.  Vulnerable to infinite
 * loops.
...
Interpreter.prototype.initGlobalScope = function(scope) {
    ...
    this.setProperty(
        scope, 'Infinity', Infinity, Interpreter.READONLY_DESCRIPTOR);
    this.setProperty(
        scope, 'undefined', undefined, Interpreter.READONLY_DESCRIPTOR);
    ...
    this.setProperty(
        scope, 'isNaN', this.createNativeFunction(isNaN, 'isNaN', false));
    ...
    for (var i = 0; i < strFunctions.length; i++) {
        ...
        this.setProperty(
            scope, strFunctions[i][1],
            this.createNativeFunction(wrapper, strFunctions[i][1], false),
            Interpreter.NONENUMERABLE_DESCRIPTOR);
    }
...
Interpreter.prototype.initConsole = function(scope) {
    var thisInterpreter = this;
    var CONSOLE = this.createObjectProto(this.OBJECT_PROTO);
    this.setProperty(CONSOLE, 'log', this.createNativeFunction(function() {
        thisInterpreter.emitEvent(
            'consoleLog', thisInterpreter.getCurrentNode(2),
            Array.prototype.join.call(arguments, ' '));
    }, 'console.log'));

    this.setProperty(scope, 'console', CONSOLE);
};
...
Interpreter.prototype.initFunction = function(scope) {
    ...
    wrapper = function(var_args) {
        ...
        thisInterpreter.setProperty(
            newFunc, 'length', newFunc.node['length'],
            Interpreter.READONLY_DESCRIPTOR);
        return newFunc;
    };
    ...
    this.setProperty(
        this.FUNCTION_PROTO, 'constructor', this.FUNCTION,
        Interpreter.NONENUMERABLE_DESCRIPTOR);
    this.FUNCTION_PROTO.nativeFunc = function() {};
    this.FUNCTION_PROTO.nativeFunc.id = this.functionCounter_++;
    this.setProperty(
        this.FUNCTION_PROTO, 'length', 0, Interpreter.READONLY_DESCRIPTOR);
    ...
    this.polyfills_.push(
        ...
        '{configurable: true, writable: true, value:', 'function(oThis) {',
    ...
    this.setProperty(
        ...
        this.createNativeFunction(wrapper, 'Function.prototype.toString', false),
        Interpreter.NONENUMERABLE_DESCRIPTOR);
    wrapper = function() {
        return this.valueOf();
    };
    ...
    this.setProperty(
        ...
        this.createNativeFunction(wrapper, 'Function.prototype.valueOf', false),
        Interpreter.NONENUMERABLE_DESCRIPTOR);
};
...
Interpreter.prototype.initObject = function(scope) {
    ...
    this.OBJECT = this.createNativeFunction(wrapper, 'Object', true);
    ...
    this.setProperty(
        ...
        this.createNativeFunction(wrapper, 'Object.getOwnPropertyNames', false),
        Interpreter.NONENUMERABLE_DESCRIPTOR);
    ...
    this.setProperty(
        this.OBJECT, 'keys',
        this.createNativeFunction(wrapper, 'Object.keys', false),
        Interpreter.NONENUMERABLE_DESCRIPTOR);
    ...
    this.setProperty(
        this.OBJECT, 'create',
        this.createNativeFunction(wrapper, 'Object.create', false),
        Interpreter.NONENUMERABLE_DESCRIPTOR);

    // Add a polyfill to handle create's second argument.
    this.polyfills_.push(
        '(function() {', 'var create_ = Object.create;',
        'Object.create = function(proto, props) {', 'var obj = create_(proto);',
        'props && Object.defineProperties(obj, props);', 'return obj;', '};',
        '})();', '');
    ...
    wrapper = function(obj, prop, descriptor) {
        ...
        if (!descriptor || !descriptor.isObject) {
            thisInterpreter.throwException(
                thisInterpreter.TYPE_ERROR, 'Property description must be an object');
        }
        ...
        thisInterpreter.setProperty(
            obj, prop, Interpreter.VALUE_IN_DESCRIPTOR, descriptor.properties);
        return obj;
    };
    this.setProperty(
        this.OBJECT, 'defineProperty',
        this.createNativeFunction(wrapper, 'Object.defineProperty', false),
        Interpreter.NONENUMERABLE_DESCRIPTOR);

    this.polyfills_.push(
        // Flatten the descriptor to remove any inheritance or getter functions.
        '(function() {', 'var defineProperty_ = Object.defineProperty;',
        'Object.defineProperty = function(obj, prop, d1) {', 'var d2 = {};',
        ...
        '{configurable: true, writable: true, value:', 'function(obj, props) {',
    ...
    this.setProperty(
        ...
        this.createNativeFunction(
            wrapper, 'Object.getOwnPropertyDescriptor', false),
        Interpreter.NONENUMERABLE_DESCRIPTOR);
    ...
    this.setProperty(
        ...
        this.createNativeFunction(wrapper, 'Object.getPrototypeOf', false),
        Interpreter.NONENUMERABLE_DESCRIPTOR);
    ...
    this.setProperty(
        this.OBJECT, 'isExtensible',
        this.createNativeFunction(wrapper, 'Object.isExtensible', false),
        Interpreter.NONENUMERABLE_DESCRIPTOR);
    ...
    this.setProperty(
        this.OBJECT, 'preventExtensions',
        this.createNativeFunction(wrapper, 'Object.preventExtensions', false),
        Interpreter.NONENUMERABLE_DESCRIPTOR);
...
Interpreter.prototype.initArray = function(scope) {
    ...
    wrapper = function(var_args) {
        ...
        if (arguments.length === 1 && typeof first === 'number') {
            if (isNaN(Interpreter.legalArrayLength(first))) {
                thisInterpreter.throwException(
                    thisInterpreter.RANGE_ERROR, 'Invalid array length');
            }
    ...
    this.ARRAY = this.createNativeFunction(wrapper, 'Array', true);
    ...
    this.setProperty(
        this.ARRAY, 'isArray',
        this.createNativeFunction(wrapper, 'Array.isArray', false),
        Interpreter.NONENUMERABLE_DESCRIPTOR);
    ...
    this.polyfills_.push(
        ...
        'var T, k;', 'var O = Object(this);', 'var len = O.length >>> 0;',
        'if (arguments.length > 1) T = thisArg;', 'k = 0;', 'while (k < len) {',
        'if (k in O && !callbackfn.call(T, O[k], k, O)) return false;', 'k++;',
        '}', 'return true;', '}', '});',
        ...
        'var t = Object(this);', 'var len = t.length >>> 0;', 'var res = [];',
        ...
        'var T, k;', 'var O = Object(this);', 'var len = O.length >>> 0;',
        'if (arguments.length > 1) T = thisArg;', 'k = 0;', 'while (k < len) {',
        'if (k in O) callback.call(T, O[k], k, O);', 'k++;', '}', '}', '});',
        ...
        'var T, A, k;', 'var O = Object(this);', 'var len = O.length >>> 0;',
        'if (arguments.length > 1) T = thisArg;', 'A = new Array(len);', 'k = 0;',
        'while (k < len) {', 'if (k in O) A[k] = callback.call(T, O[k], k, O);',
        'k++;', '}', 'return A;', '}', '});',
        ...
        'while (k < len && !(k in t)) k++;', 'if (k >= len) {',
        'throw TypeError(\'Reduce of empty array with no initial value\');', '}',
        'value = t[k++];', '}', 'for (; k < len; k++) {',
        'if (k in t) value = callback(value, t[k], k, t);', '}', 'return value;',
        '}', '});',
        ...
        '(function() {', 'var sort_ = Array.prototype.sort;',
        'Array.prototype.sort = function(opt_comp) {',
        // Fast native sort.
        'if (typeof opt_comp !== \'function\') {', 'return sort_.call(this);',
        '}',
        // Slow bubble sort.
        'for (var i = 0; i < this.length; i++) {', 'var changes = 0;',
        'for (var j = 0; j < this.length - i - 1; j++) {',
        'if (opt_comp(this[j], this[j + 1]) > 0) {', 'var swap = this[j];',
        'this[j] = this[j + 1];', 'this[j + 1] = swap;', 'changes++;', '}', '}',
        'if (!changes) break;', '}', 'return this;', '};', '})();',

        'Object.defineProperty(Array.prototype, \'toLocaleString\',',
        '{configurable: true, writable: true, value:', 'function() {',
        'var out = [];', 'for (var i = 0; i < this.length; i++) {',
...
Interpreter.prototype.initString = function(scope) {
    ...
    this.STRING = this.createNativeFunction(wrapper, 'String', true);
    this.setProperty(scope, 'String', this.STRING);

    // Static methods on String.
    this.setProperty(
        this.STRING, 'fromCharCode',
        this.createNativeFunction(
            String.fromCharCode, 'String.fromCharCode', false),
        Interpreter.NONENUMERABLE_DESCRIPTOR);

    // Instance methods on String.
    // Methods with exclusively primitive arguments.
    var functions = [
        'charAt', 'charCodeAt', 'concat', 'indexOf', 'lastIndexOf', 'slice',
        'substr', 'substring', 'toLocaleLowerCase', 'toLocaleUpperCase',
        'toLowerCase', 'toUpperCase', 'trim'
    ];
    for (var i = 0; i < functions.length; i++) {
        this.setNativeFunctionPrototype(
            this.STRING, functions[i], String.prototype[functions[i]]);
    }
    ...
    this.polyfills_.push(
        '(function() {', 'var replace_ = String.prototype.replace;',
        'String.prototype.replace = function(substr, newSubstr) {',
        'if (typeof newSubstr !== \'function\') {',
        // string.replace(string|regexp, string)
        'return replace_.call(this, substr, newSubstr);', '}', 'var str = this;',
        'if (substr instanceof RegExp) {', // string.replace(regexp, function)
        'var subs = [];', 'var m = substr.exec(str);', 'while (m) {',
        'm.push(m.index, str);', 'var inject = newSubstr.apply(null, m);',
        ...
        'var i = str.indexOf(substr);', 'if (i !== -1) {',
...
Interpreter.prototype.initBoolean = function(scope) {
    ...
    this.BOOLEAN = this.createNativeFunction(wrapper, 'Boolean', true);
...
Interpreter.prototype.initNumber = function(scope) {
    ...
    this.NUMBER = this.createNativeFunction(wrapper, 'Number', true);
    ...
    for (var i = 0; i < numConsts.length; i++) {
        this.setProperty(
            this.NUMBER, numConsts[i], Number[numConsts[i]],
            Interpreter.READONLY_NONENUMERABLE_DESCRIPTOR);
    }
...
Interpreter.prototype.initDate = function(scope) {
    ...
    this.DATE = this.createNativeFunction(wrapper, 'Date', true);
    this.DATE_PROTO = this.DATE.properties['prototype'];
    this.setProperty(scope, 'Date', this.DATE);

    // Static methods on Date.
    this.setProperty(
        this.DATE, 'now', this.createNativeFunction(Date.now, 'Date.now', false),
        Interpreter.NONENUMERABLE_DESCRIPTOR);
    ...
    this.setProperty(
        this.DATE, 'UTC', this.createNativeFunction(Date.UTC, 'Date.UTC', false),
        Interpreter.NONENUMERABLE_DESCRIPTOR);
...
Interpreter.prototype.initRegExp = function(scope) {
    ...
    this.REGEXP = this.createNativeFunction(wrapper, 'RegExp', true);
    this.REGEXP_PROTO = this.REGEXP.properties['prototype'];
    this.setProperty(scope, 'RegExp', this.REGEXP);

    this.setProperty(
        this.REGEXP.properties['prototype'], 'global', undefined,
        Interpreter.READONLY_NONENUMERABLE_DESCRIPTOR);
    this.setProperty(
        this.REGEXP.properties['prototype'], 'ignoreCase', undefined,
        Interpreter.READONLY_NONENUMERABLE_DESCRIPTOR);
    this.setProperty(
        this.REGEXP.properties['prototype'], 'multiline', undefined,
        Interpreter.READONLY_NONENUMERABLE_DESCRIPTOR);
    this.setProperty(
        this.REGEXP.properties['prototype'], 'source', '(?:)',
        Interpreter.READONLY_NONENUMERABLE_DESCRIPTOR);
...
Interpreter.prototype.initError = function(scope) {
    ...
    this.ERROR = this.createNativeFunction(function(opt_message) {
        ...
        if (opt_message) {
            thisInterpreter.setProperty(
                newError, 'message', String(opt_message),
                Interpreter.NONENUMERABLE_DESCRIPTOR);
        }
        return newError;
    }, 'Error', true);
    ...
    this.setProperty(
        this.ERROR.properties['prototype'], 'message', '',
        Interpreter.NONENUMERABLE_DESCRIPTOR);
    this.setProperty(
        this.ERROR.properties['prototype'], 'name', 'Error',
        Interpreter.NONENUMERABLE_DESCRIPTOR);

    var createErrorSubclass = function(name) {
        var constructor =
            thisInterpreter.createNativeFunction(function(opt_message) {
                if (thisInterpreter.calledWithNew()) {
        ...
        thisInterpreter.setProperty(
            constructor.properties['prototype'], 'name', name,
            Interpreter.NONENUMERABLE_DESCRIPTOR);
...
Interpreter.prototype.initMath = function(scope) {
    ...
    for (var i = 0; i < mathConsts.length; i++) {
        this.setProperty(
            myMath, mathConsts[i], Math[mathConsts[i]],
            Interpreter.READONLY_NONENUMERABLE_DESCRIPTOR);
    }
    var numFunctions = [
    ...
    for (var i = 0; i < numFunctions.length; i++) {
        this.setProperty(
            myMath, numFunctions[i],
            this.createNativeFunction(
                Math[numFunctions[i]], 'Math.' + numFunctions[i], false),
            Interpreter.NONENUMERABLE_DESCRIPTOR);
    }
};
...
Interpreter.prototype.initJSON = function(scope) {
    ...
    this.setProperty(
        myJSON, 'parse', this.createNativeFunction(wrapper, 'JSON.parse', false));
    ...
    this.setProperty(
        myJSON, 'stringify',
        this.createNativeFunction(wrapper, 'JSON.stringify', false));
};
...
Interpreter.Object.prototype.valueOf = function() {
    ...
    return /** @type {(boolean|number|string)} */ (
        this.data); // Boxed primitive.
};
...
Interpreter.prototype.createObjectProto = function(proto) {
    ...
    if (this.isa(obj, this.FUNCTION)) {
        this.setProperty(
            obj, 'prototype', this.createObjectProto(this.OBJECT_PROTO || null));
        obj.class = 'Function';
    }
    // Arrays have length.
    if (this.isa(obj, this.ARRAY)) {
        this.setProperty(
            obj, 'length', 0, { configurable: false, enumerable: false, writable: true });
        obj.class = 'Array';
    }
...
Interpreter.prototype.populateRegExp = function(pseudoRegexp, nativeRegexp) {
    ...
    this.setProperty(
        pseudoRegexp, 'lastIndex', nativeRegexp.lastIndex,
        Interpreter.NONENUMERABLE_DESCRIPTOR);
    this.setProperty(
        pseudoRegexp, 'source', nativeRegexp.source,
        Interpreter.READONLY_NONENUMERABLE_DESCRIPTOR);
    this.setProperty(
        pseudoRegexp, 'global', nativeRegexp.global,
        Interpreter.READONLY_NONENUMERABLE_DESCRIPTOR);
    this.setProperty(
        pseudoRegexp, 'ignoreCase', nativeRegexp.ignoreCase,
        Interpreter.READONLY_NONENUMERABLE_DESCRIPTOR);
    this.setProperty(
        pseudoRegexp, 'multiline', nativeRegexp.multiline,
        Interpreter.READONLY_NONENUMERABLE_DESCRIPTOR);
};
...
Interpreter.prototype.createFunction = function(node, scope) {
    ...
    func.node = node;
    this.setProperty(
        func, 'length', func.node['params'].length,
        Interpreter.READONLY_DESCRIPTOR);
    return func;
};
 ...
 * @param {!string} tag Native function tag
...
Interpreter.prototype.createNativeFunction = function(
    nativeFunc, tag, opt_constructor) {
    var func = this.createObjectProto(this.FUNCTION_PROTO);
    func.tag = tag;
    func.nativeFunc = nativeFunc;
    nativeFunc.id = this.functionCounter_++;
    this.setProperty(
        func, 'length', nativeFunc.length, Interpreter.READONLY_DESCRIPTOR);
    if (opt_constructor) {
        this.setProperty(
            func.properties['prototype'], 'constructor', func,
            Interpreter.NONENUMERABLE_DESCRIPTOR);
...
Interpreter.prototype.createAsyncFunction = function(asyncFunc) {
    ...
    this.setProperty(
        func, 'length', asyncFunc.length, Interpreter.READONLY_DESCRIPTOR);
    return func;
};
...
Interpreter.prototype.nativeToPseudo = function(nativeObj) {
    ...
    if (nativeObj instanceof Function) {
        ...
        var wrapper = function() {
            return interpreter.nativeToPseudo(nativeObj.apply(
                interpreter, Array.prototype.slice.call(arguments).map(function(i) {
                    return interpreter.pseudoToNative(i);
                })));
        };
        return this.createNativeFunction(wrapper, 'nativeToPseudo', undefined);
    }
...
Interpreter.prototype.pseudoToNative = function(pseudoObj, opt_cycles) {
    ...
    var cycles = opt_cycles || { pseudo: [], native: [] };
...
Interpreter.prototype.getProperty = function(obj, name) {
    ...
    if (obj === undefined || obj === null) {
        this.throwException(
            this.TYPE_ERROR, 'Cannot read property \'' + name + '\' of ' + obj);
    }
    if (name === 'length') {
...
Interpreter.prototype.setProperty = function(obj, name, value, opt_descriptor) {
    ...
    if (obj === undefined || obj === null) {
        this.throwException(
            this.TYPE_ERROR, 'Cannot set property \'' + name + '\' of ' + obj);
    }
    ...
    if (opt_descriptor) {
        ...
        if (defObj.getter && defObj.getter[name]) {
            if (strict) {
                this.throwException(
                    this.TYPE_ERROR,
                    'Cannot set property \'' + name + '\' of object \'' + obj +
...
Interpreter.prototype.setNativeFunctionPrototype = function(
    obj, name, wrapper) {
    this.setProperty(
        obj.properties['prototype'], name,
        this.createNativeFunction(wrapper, 'prototype.' + name, false),
        Interpreter.NONENUMERABLE_DESCRIPTOR);
};
...
Interpreter.prototype.populateScope_ = function(node, scope) {
    if (node['type'] === 'VariableDeclaration') {
        ...
        this.setProperty(
            scope, node['id']['name'], this.createFunction(node, scope),
            Interpreter.VARIABLE_DESCRIPTOR);
...
Interpreter.prototype.throwException = function(errorClass, opt_message) {
    if (opt_message === undefined) {
        ...
        this.setProperty(
            error, 'message', opt_message, Interpreter.NONENUMERABLE_DESCRIPTOR);
    }
...
Interpreter.prototype.createGetter_ = function(func, left) {
    ...
    var state = new Interpreter.State(
        node, this.stateStack[this.stateStack.length - 1].scope);
...
Interpreter.prototype['stepAssignmentExpression'] = function(
    ...
    this.emitEvent('assignmentSet', state.leftReference_, value);
    ...
    switch (node['operator']) {
        ...
        case 'instanceof':
            if (!this.isa(rightValue, this.FUNCTION)) {
                this.throwException(
                    this.TYPE_ERROR, 'Right-hand side of instanceof is not an object');
            }
...
Interpreter.prototype['stepCallExpression'] = function(stack, state, node) {
    ...
    if (!state.doneExec_) {
        ...
        if (func.tag) {
            this.emitEvent('onTagCall', node, func.tag);
        }
        if (funcNode) {
            ...
            this.setProperty(
                scope, 'this', state.funcThis_, Interpreter.READONLY_DESCRIPTOR);
...
// // Preserve top-level API functions from being pruned/renamed by JS
// compilers.
// // Add others as needed.
...
// Interpreter.prototype.nativeToPseudo; Interpreter.prototype['pseudoToNative']
// = Interpreter.prototype.pseudoToNative;
// Interpreter.prototype['getCurrentNode'] =
// Interpreter.prototype.getCurrentNode; Interpreter.prototype['getAllNodes'] =
// Interpreter.prototype.getAllNodes;
// // Obsolete.  Do not use.
